			...
			>
				...
				<View style={[styles.section, { backgroundColor: theme.cards }]}>
					...
					<Text style={[styles.text, { color: theme.text }]}>
						...
						carefully before using the GoBuyMe app.
					</Text>
					...
					<Text style={[styles.text, { color: theme.text }]}>
						If you wish to purchase any product or service, you may be asked to
					...
					<Text style={[styles.text, { color: theme.text }]}>
						...
						<Text style={[{ color: theme.primary }]}>support@gobuyme.shop</Text>
						.
					</Text>
				</View>
			</ScrollView>
